...
int main(int argc, char **argv) {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = new Fl_Double_Window(160, 415, "Netcard Conf");
    w = o;
    { Fl_Box* o = new Fl_Box(5, 2, 150, 28, "Netcard Conf");
      o->labeltype(FL_ENGRAVED_LABEL);
      o->labelsize(18);
    } // Fl_Box* o
    { interfaceInput = new Fl_Input(20, 41, 115, 24, "Interface");
    ...
    { Fl_Group* o = new Fl_Group(5, 85, 155, 20, "Use DHCP Broadcast?");
      o->labelfont(1);
      o->labelsize(12);
      { dhcpYesBtn = new Fl_Round_Button(30, 90, 45, 15, "yes");
      ...
      { dhcpNoBtn = new Fl_Round_Button(75, 90, 45, 15, "no");
    ...
    { ipAddressInput = new Fl_Input(20, 121, 115, 24, "IP Address");
    ...
    { netMaskInput = new Fl_Input(20, 161, 115, 24, "Network Mask");
    ...
    { broadcastInput = new Fl_Input(20, 201, 115, 24, "Broadcast");
    ...
    { gatewayInput = new Fl_Input(20, 241, 115, 24, "Gateway");
    ...
    { nameserv1Input = new Fl_Input(20, 281, 115, 24, "NameServers");
    ...
    { Fl_Group* o = new Fl_Group(20, 350, 130, 10, "Save Configuration?");
      o->labelfont(1);
      o->labelsize(12);
      { SaveYesBtn = new Fl_Round_Button(30, 350, 45, 10, "yes");
      ...
      { SaveNoBtn = new Fl_Round_Button(75, 350, 50, 10, "no");
    ...
    { Fl_Button* o = new Fl_Button(15, 375, 65, 25, "&Apply");
      o->callback((Fl_Callback*)btnCallback, (void*)("apply"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(85, 375, 65, 25, "E&xit");
