...
static string fmtoutput(const string target, char action, int min, int max, int width) {
  istringstream iss;
ostringstream oss;
int result;
iss.str(target);
...
textdomain("tinycore");
  { Fl_Double_Window* o = new Fl_Double_Window(195, 195, gettext("Datetool"));
    w = o;
    { yearInput = new Fl_Input(60, 11, 60, 25, gettext("Year:"));
    } // Fl_Input* yearInput
    { Fl_Button* o = new Fl_Button(125, 10, 25, 25, gettext("@<"));
      o->callback((Fl_Callback*)btnCallback, (void*)("yearDown"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(155, 10, 25, 25, gettext("@>"));
      o->callback((Fl_Callback*)btnCallback, (void*)("yearUp"));
    } // Fl_Button* o
    { monthInput = new Fl_Input(60, 40, 60, 25, gettext("Month:"));
    } // Fl_Input* monthInput
    { Fl_Button* o = new Fl_Button(125, 39, 25, 25, gettext("@<"));
      o->callback((Fl_Callback*)btnCallback, (void*)("monthDown"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(155, 39, 25, 25, gettext("@>"));
      o->callback((Fl_Callback*)btnCallback, (void*)("monthUp"));
    } // Fl_Button* o
    { dayInput = new Fl_Input(60, 70, 60, 25, gettext("Day:"));
    } // Fl_Input* dayInput
    { Fl_Button* o = new Fl_Button(125, 69, 25, 25, gettext("@<"));
      o->callback((Fl_Callback*)btnCallback, (void*)("dayDown"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(155, 69, 25, 25, gettext("@>"));
      o->callback((Fl_Callback*)btnCallback, (void*)("dayUp"));
    } // Fl_Button* o
    { hourInput = new Fl_Input(60, 100, 60, 25, gettext("Hour:"));
    } // Fl_Input* hourInput
    { Fl_Button* o = new Fl_Button(125, 99, 25, 25, gettext("@<"));
      o->callback((Fl_Callback*)btnCallback, (void*)("hourDown"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(155, 99, 25, 25, gettext("@>"));
      o->callback((Fl_Callback*)btnCallback, (void*)("hourUp"));
    } // Fl_Button* o
    { minInput = new Fl_Input(60, 130, 60, 25, gettext("Min:"));
    } // Fl_Input* minInput
    { Fl_Button* o = new Fl_Button(125, 129, 25, 25, gettext("@<"));
      o->callback((Fl_Callback*)btnCallback, (void*)("minDown"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(155, 129, 25, 25, gettext("@>"));
      o->callback((Fl_Callback*)btnCallback, (void*)("minUp"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(28, 163, 64, 25, gettext("&OK"));
      o->callback((Fl_Callback*)btnCallback, (void*)("ok"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(103, 163, 64, 25, gettext("&Cancel"));
