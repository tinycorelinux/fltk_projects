    ...
    { tabs = new Fl_Tabs(0, 0, 660, 386);
      ...
      { Fl_Group* o = new Fl_Group(0, 0, 660, 335, gettext("filesystems"));
        ...
        { filesystemsDisplay = new Fl_Text_Display(0, 0, 660, 335);
          ...
          filesystemsDisplay->textsize(10);
