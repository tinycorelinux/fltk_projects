...
int main(int argc, char **argv) {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = new Fl_Double_Window(225, 80, "Filetool");
    w = o;
    { input_device = new Fl_Input(65, 7, 150, 25, "Device:");
      input_device->callback((Fl_Callback*)input_callback);
      input_device->when(FL_WHEN_CHANGED);
    } // Fl_Input* input_device
    { btn_none = new Fl_Button(10, 40, 64, 30, "&None");
      btn_none->callback((Fl_Callback*)btn_callback, (void*)("none"));
      btn_none->deactivate();
    } // Fl_Button* btn_none
    { btn_backup = new Fl_Button(80, 40, 64, 30, "&Backup");
      btn_backup->callback((Fl_Callback*)btn_callback, (void*)("backup"));
      btn_backup->deactivate();
    } // Fl_Button* btn_backup
    { btn_restore = new Fl_Button(150, 40, 64, 30, "&Restore");
      btn_restore->callback((Fl_Callback*)btn_callback, (void*)("restore"));
