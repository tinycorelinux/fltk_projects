...
textdomain("tinycore");
  { Fl_Double_Window* o = new Fl_Double_Window(145, 200, gettext("Mouse Tool"));
    ...
    { btn_right = new Fl_Round_Button(20, 100, 103, 20, gettext("Right Button"));
    ...
    { btn_left = new Fl_Round_Button(20, 120, 103, 20, gettext("Left Button"));
    ...
    { Fl_Button* o = new Fl_Button(20, 155, 50, 25, gettext("&Apply"));
      o->callback((Fl_Callback*)btn_callback, (void*)("apply"));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(75, 155, 50, 25, gettext("&Exit"));
