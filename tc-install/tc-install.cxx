...
static string image,type,installMode, target,dev,format,path,boot,flag, markActive; 
static string warn="Mark active only if Tiny Core is the only operation system.\nOtherwise use Grub extension after installation."; 
