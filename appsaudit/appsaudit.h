...
#define menuDepends (menu_menuBar+0)
#define menu_auditall (menu_menuBar+3)
#define menu_fetchmissing (menu_menuBar+4)
#define menu_nodepends (menu_menuBar+5)
#define menu_notrequired (menu_menuBar+6)
#define menu_dependson (menu_menuBar+7)
#define menu_requiredby (menu_menuBar+8)
#define menu_missing (menu_menuBar+9)
#define menu_delete (menu_menuBar+10)
#define menu_marked (menu_menuBar+11)
#define menu_clearlst (menu_menuBar+12)
#define menuInstall (menu_menuBar+15)
#define menuUpdates (menu_menuBar+20)
#define menuMd5s (menu_menuBar+25)
#define menuOnBoot (menu_menuBar+29)
#define menuOnDemand (menu_menuBar+33)
#endif
